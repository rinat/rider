...
import rider.controller.RenameBookmarkController;
 ...
 * @see RenameBookmarkController
 */
public class RenameBookmarkView extends Form implements IView {
    ...
    public RenameBookmarkView(MIDletThreadSafe midlet, IView backDisplay) throws NullPointerException {
        super(Localization.getInstance().strings().get("kRenameBookmark"));
        if (midlet == null || backDisplay == null) {
            //#ifdef rider.debugEnabled
            InternalLogger.getInstance().fatal(new NullPointerException("RenameBookmarkView.RenameBookmarkView"));
            //#endif
    ...
    public void attachController(IController controller) throws NullPointerException {
        if (controller == null) {
            //#ifdef rider.debugEnabled
            InternalLogger.getInstance().fatal(new NullPointerException("RenameBookmarkView.attachController"));
            //#endif
            throw new NullPointerException();
        }
